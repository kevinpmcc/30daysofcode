...
public class MadLibs {
    ...
    public void printInstructions() {
        System.out.println("Welcome to the Mad Libs game. If you type in "
                            + "words, we'll give you a story. Start by typing"
                            + "in a name.");
    }
    ...
    public void enterAdjective1() {
        System.out.println("I'd really love an adjective");
        setAdjective1(scanner.nextLine());
    }
    
    public void enterAdjective2() {
        System.out.println("One is just never enough, another adjective please");
        setAdjective2(scanner.nextLine());
    }
    
    public void enterAdverb() {
        System.out.println("Nearly there, throw me an adverb");
    ...
    public void putTogetherTheStory() {
        ...
        if (num == 0) {
           story = "Jesse and her best friend "+getName()+" went to Disney World today!"
                ...
                + " day I ran" +getAdverb()+ " to meet Mickey Mouse in his "
            ...
            story = "Amanda and her frenemy" +getName()+" went to the zoo "
                    +"last summer, They saw a huge "+getNoun1()+" and a tiny little "
                    +getNoun2()+ ". That night they decided to climb "+getAdverb()
                    +" into the "+getNoun3()+ " to get a better look. The zoo "
                    +"was closed but they didn't care..."
                    +"until " + getRandomNums()+ " " +getAdjective2() + " apes yelled"
                    +" in their faces, making Amanda and "+getName()+" sprint all"
                    +" the way back home.";
        }
             setStory(story);
    }
